//! BharatOS kernel slab allocator
#![no_std]
#![allow(unused)]

use crate::prelude::*;

pub const SLAB_SIZES: [usize; 13] = [8, 16, 32, 64, 128, 256, 512, 1024, 2048, 4096, 8192, 16384, 32768];
...
pub struct SlabObject {
    pub next: Option<&'static mut SlabObject>,
    pub slab: *mut Slab,
}

pub struct ColorResult {
    pub cache: *mut SlabCache,
    pub object: *mut SlabObject,
    pub slab: *mut Slab,
}
...
fn find_cache(size: usize) -> Option<usize> {
...
fn alloc_from_cache(cache: &mut SlabCache) -> ColorResult {
    let obj = cache.free_list.take();
